...
export function StrategicMessagingOutputView({ output }: { output?: StrategicMessagingOutput }) {
  if (!output) {
    return <div className="rounded border border-[#E5E3DC] bg-[#FFFFFF] p-6 text-sm">You will receive: Strategic Rewrite, What Changed and Why, Intent Preserved, Terms to Reconsider, Stronger Alternative Phrases, and Message Readiness Score.</div>;
  }

  return (
    <div className="space-y-5 rounded border border-[#E5E3DC] bg-[#FFFFFF] p-6">
